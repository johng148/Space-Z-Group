...
veteran : Person 'veteran' 'veteran'  // Defines this NPC as a veteran
    ...
    pic = artBanner.showArt('veteran') // The art that is displayed when the item is looked at.
;
...
+ veteranTalking : InConversationState  // Defines what the NPC is doing when in conversation.
    ...
    specialDesc = "{The veteran/he} is standing while talking with you."  // Description of NPC is during a special conversation.
;
